...
const metadataConfigPath = path.join(__dirname, '../src/app/calculators/metadata-configs.js');
const { calculatorMetadata } = await import(metadataConfigPath);

const APP_DIR = path.join(__dirname, '..', 'src', 'app');

// Function to create metadata file content
const createMetadataContent = (metadata) => {
